...
public class S6P3 extends DefaultPanel {


    List<Point> polygon;
    List<Point> sortedPolygonPoints;
    Timer timer;
    int count1 = 0;
    int count2 = 0;
    int count3 = 0;
    public S6P3() {
        ...
        sortedPolygonPoints = new ArrayList<>(polygon);
        sortedPolygonPoints.sort((point, t1) -> {
            if (point.x == t1.x)
                return point.y - t1.y;
            return point.x - t1.x;
        });
    ...
    public void paint(Graphics graphics) {
        ...
        for (int i = 0; i < count3; i++) {
            Point a = sortedPolygonPoints.get(0);
